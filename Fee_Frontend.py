...
class Fee():
    def __init__(self, master):
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='snow2')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='snow2', relief='ridge', bd=15)
        Title_Frame.pack(side=TOP)

        self.lblTitle = Label(Title_Frame, font=('Harrington', 40, 'bold'), text='FEE REPORT',
                              bg='snow2', padx=13)
        self.lblTitle.grid(padx=400)

        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='snow2', relief='ridge', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='snow2', relief='ridge', bd=8,
                             text='Informations', font=('Harrington', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='snow2', relief='ridge', bd=8,
                             text='Fee Receipt', font=('Harrington', 15, 'bold'))
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CSE', 'IT', 'ETC/ET&T', 'Mechanical', 'Civil', 'EE', 'EEE'),
                                         font=('Harrington', 14), width=19, textvariable=self.branch)
        ...
        self.list = Listbox(List_Frame, font=(
            'Harrington', 13, 'bold'), width=140, height=8)
