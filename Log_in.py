...
class Window_1:
    def __init__(self, master):
        ...
        self.master.config(bg = 'gray95')
        self.Frame = Frame(self.master, bg = 'gray95')
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Menu', font = ('Harrington',55,'bold'), bg = 'gray95', fg = 'Black')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief = 'ridge', bg = 'gray95', bd = 15,
                                        font = ('Harrington',20,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief = 'ridge',bg = 'gray95', bd = 15,
                                        font = ('Harrington',20,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('Harrington',20,'bold'), bg = 'gray95', bd = 20)
        self.Label_Username.grid(row = 0, column = 0)
        self.text_Username = Entry(self.Login_Frame_1, font = ('Harrington',20,'bold'), textvariable = self.Username)
        self.text_Username.grid(row = 0, column = 1, padx = 50)                       
        
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('Harrington',20,'bold'), bg = 'gray95', bd = 20)
        self.Label_Password.grid(row = 1, column = 0)
        self.text_Password = Entry(self.Login_Frame_1, font = ('Harrington',20,'bold'), show = '*', textvariable = self.Password)
    ...
    def Login(self):
        ...
        if (u == str('TEAMRED') and p == str(12345678)):
            self.__menu__()
        else:
