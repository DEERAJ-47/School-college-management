       ...
       def __init__(self, master):
              ...
              #========================================================Variables=====================================================================
               ...
               #==========================================================Functions====================================================================
                     ...
                     self.Main_Frame = LabelFrame(self.master, width = 1300, height = 500, font = ('Harrington',20,'bold'), \
                                                  bg = 'snow2',bd = 15, relief = 'ridge')
                     self.Main_Frame.grid(row = 0, column = 0, padx = 10, pady = 20)

                     self.Frame_1 = LabelFrame(self.Main_Frame, width = 600, height = 400, font = ('Harrington',15,'bold'), \
                                               relief = 'ridge', bd = 10, bg = 'snow2', text = 'STUDENT INFORMATION ')
                     self.Frame_1.grid(row = 1, column = 0, padx = 10)

                     self.Frame_2 = LabelFrame(self.Main_Frame, width = 750, height = 400, font = ('Harrington',15,'bold'), \
                                               relief = 'ridge', bd = 10, bg = 'snow2', text = 'STUDENT DATABASE')
                     self.Frame_2.grid(row = 1, column = 1, padx = 5)                  
                     
                     self.Frame_3 = LabelFrame(self.master, width = 1200, height = 100, font = ('Harrington',10,'bold'), \
                                               bg = 'snow2', relief = 'ridge', bd = 13)
                     self.Frame_3.grid(row = 2, column = 0, pady = 10)


                     
                     #========================================================Labels of Frame_1========================================================
                     self.Label_name = Label(self.Frame_1, text = 'Name', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_name.grid(row = 0, column = 0, sticky = W, padx = 20, pady = 10)
                     self.Label_fname = Label(self.Frame_1, text = 'Father Name', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_fname.grid(row = 1, column = 0, sticky = W, padx = 20)
                     self.Label_mname = Label(self.Frame_1, text = 'Mother Name', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_mname.grid(row = 2, column = 0, sticky = W, padx = 20)
                     self.Label_address = Label(self.Frame_1, text = 'Address', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_address.grid(row = 3, column = 0, sticky = W, padx = 20)
                     self.Label_mobno = Label(self.Frame_1, text = 'Mobile Number', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_mobno.grid(row = 4, column = 0, sticky = W, padx = 20)
                     self.Label_emailID = Label(self.Frame_1, text = 'Email ID', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_emailID.grid(row = 5, column = 0, sticky = W, padx = 20)
                     self.Label_dob = Label(self.Frame_1, text = 'Date of Birth', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_dob.grid(row = 6, column = 0, sticky = W, padx = 20)
                     self.Label_gender = Label(self.Frame_1, text = 'Gender', font = ('Harrington',20,'bold'),  bg = 'snow2')
                     self.Label_gender.grid(row = 7, column = 0, sticky = W, padx = 20, pady = 10)


                     #========================================================Entries of Frame_1========================================================
                     self.Entry_name = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.name)
                     self.Entry_name.grid(row = 0, column = 1, padx = 10, pady = 5)
                     self.Entry_fname = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.fname)
                     self.Entry_fname.grid(row = 1, column = 1, padx = 10, pady = 5)
                     self.Entry_mname = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.mname)
                     self.Entry_mname.grid(row = 2, column = 1, padx = 10, pady = 5)
                     self.Entry_address = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.address)
                     self.Entry_address.grid(row = 3, column = 1, padx = 10, pady = 5)
                     self.Entry_mobno = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.mobno)
                     self.Entry_mobno.grid(row = 4, column = 1, padx = 10, pady = 5)
                     self.Entry_emailID = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.email)
                     self.Entry_emailID.grid(row = 5, column = 1, padx = 10, pady = 5)
                     self.Entry_dob = Entry(self.Frame_1, font = ('Harrington',17,'bold'), textvariable = self.dob)
                     self.Entry_dob.grid(row = 6, column = 1, padx = 10, pady = 5)
                     self.Entry_gender = ttk.Combobox(self.Frame_1, values = (' ','Male','Female','Others'),\
                                                      font = ('Harrington',17,'bold'), textvariable = self.gender, width = 19)
                     ...
                     self.btnSave = Button(self.Frame_3, text = 'SAVE', font = ('Harrington',17,'bold'), width = 8, command = Add)
                     self.btnSave.grid(row = 0, column = 0, padx = 10, pady = 10)
                     self.btnDisplay = Button(self.Frame_3, text = 'DISPLAY', font = ('Harrington',17,'bold'), width = 8, command = Display)
                     self.btnDisplay.grid(row = 0, column = 1, padx = 10, pady = 10)
                     self.btnReset = Button(self.Frame_3, text = 'RESET', font = ('Harrington',17,'bold'), width = 8, command = Reset)
                     self.btnReset.grid(row = 0, column = 2, padx = 10, pady = 10)
                     self.btnUpdate = Button(self.Frame_3, text = 'UPDATE', font = ('Harrington',17,'bold'), width = 8, command = Update)
                     self.btnUpdate.grid(row = 0, column = 3, padx = 10, pady = 10)
                     self.btnDelete = Button(self.Frame_3, text = 'DELETE', font = ('Harrington',17,'bold'), width = 8, command = Delete)
                     self.btnDelete.grid(row = 0, column = 4, padx = 10, pady = 10)
                     self.btnSearch = Button(self.Frame_3, text = 'SEARCH', font = ('Harrington',17,'bold'), width = 8, command = Search )
                     self.btnSearch.grid(row = 0, column = 5, padx = 10, pady = 10)
                     self.btnExit = Button(self.Frame_3, text = 'EXIT', font = ('Harrington',17,'bold'), width = 8, command = Exit)
                     ...
                     self.listbox = Listbox(self.Frame_2, width = 75, height = 20 , font = ('Harrington',12,'bold'))
